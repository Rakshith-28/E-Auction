...
public class AuctionController {
    ...
    @GetMapping
    public ResponseEntity<Page<AuctionResponse>> getAuctions(@PageableDefault(size = 20) Pageable pageable) {
    ...
    @GetMapping("/active")
    public ResponseEntity<java.util.List<AuctionResponse>> activeAuctions() {
